...
class Catalogo extends React.Component{
    ...
    agregarProducto(){
        ...
        if(cantidad <= 0){
            alert('Seleccion una cantidad dentro de la existencia del producto')
            return
        }
        if(this.state.disponible < cantidad){
            alert('Maxima existencia en cantidad es: '+this.state.disponible)
        }
        else{
            ...
            this.state.productoCarrito.llave = this.props.llave
    ...
    checkCarrito(id){
        ...
        for(let itemCarrito of this.state.listaCarrito){
            if(itemCarrito.id == productoCarrito.id){
                ...
                this.setState({disponible : actualizarDisponible, contadorCarrito : itemCarrito})
            }
        }
    }
                ...
                <div className="card">
                    ...
                    <div className="card-content">
                        <div className="informacion blue-grey-text text-darken-2">
                            <span hidden={this.state.contadorCarrito ? false : true} className="badge carrito"><Link to="/carrito"><small className="white-text text-shadow"><i className="material-icons left">shopping_cart</i><p className="left "></p></small></Link></span>
